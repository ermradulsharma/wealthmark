                               ...
                               <div class="col-md-12">
                                    <form action="" method="post" id="email_otp_frm">
                                        @csrf
                                         <div class="verification_div">
                                            <div class="verification_main">
                                               <div class="verification_inner inner-css">
                                                  <input type="input" pattern="\d*" maxlength="6" oninput="activeButton(this.id),this.value=this.value.replace(/[^0-9]/g,'') " aria-label="Phone Number Verification Code" id="otp" class="verification_textbox" value="">
                                         ...
                                         <div class="btn-div">
                                            <button type="button" class="submit_code disable btn-yellow mt-4 w-100">
            	...
            	$(document).ready(function () {
            	    ...
            	    $("#otp").on("input", function(e) {
            			...
            			if(count==6){
            				...
            				$.ajax({
            					type: "POST",
            					url: "{{ url( app()->getLocale()) }}/verify_email_otp",
            					data: {'email_otp':otp,'_token':_token},
            					dataType: "json",
            					encode: true,
            				}).done(function (data) {
                				triggerAlert('Congratulations! Email successfully verified.', 'success');
                				setTimeout(function(){
                                    window.location.href = '<?php echo url( app()->getLocale());  ?>/user/dashboard';
                                }, 2000);
