...
<!--    		<a type="button" href="{{ url('LoggedinWithemail-confirm-redirection') }}" class="btn-yellow shadow loginconfirm" >Confirm</a>-->
<!--	      </div>-->
                    ...
                    <div class="container-fluid p-0 m-0">
                            <div class="row">
                                ...
                                <div class="d-block col-12 mt-3 w-100 text-center mb-3">
                                    ...
                                    <a href="{{ url('LoggedinWithemail-confirm-redirection') }}" class="btn-yellow border-0 d-inline-block oginconfirm">
                                        Confirm
                                    </a>
                                </div>
