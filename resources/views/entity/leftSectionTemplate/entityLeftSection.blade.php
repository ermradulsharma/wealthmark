   <div class="left-inner">
               <div class="border-box">
                  ...
                  <div class="opt-display ">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="left-svg-icon" style="display:none;">
                     ...
                     <div class="opt-display-txt appendEntityType"></div>
                  </div>
                  <div class="opt-display">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="left-svg-icon" style="display:none;">
                     ...
                     <div class="opt-display-txt appendCompanyType"></div>
                  </div>
               </div>
