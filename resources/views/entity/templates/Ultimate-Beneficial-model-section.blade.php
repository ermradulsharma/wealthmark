 ...
 <div class="modal custom_modal" id="Add-Ultimate-Beneficial">
         ...
         <div class="modal-box" style="max-width:850px;">
            ...
            <div class="modal-body text-start">
               ...
               <form action="#" style="width: 100%;" enctype="multipart/form-data" id="beneficialOwner">
                      @csrf
                      <div>
                     <!-- <input type="text" hidden="" name="pdId" id="owner_pId" value="" class="form-control " placeholder="">-->
                     <input type="text" hidden="" name="partnerId" id="owner_partnerId" value="2" class="form-control " placeholder="">
                   <!--  <input type="text" hidden="" id="owner_directoType" name="directoType" value="" class="form-control " placeholder="">-->
                     ...
                     <div class="d-column">
                        ...
                        <div class="column3">
                           <div class="form-floating mb-3 clearable-input">
                              <input type="text" id="owner_fname" name="owner_fname" value="" class="form-control searchinput" placeholder="demo">
                              <label>First Name</label>
                           </div>
                           <div class="form-floating mb-3 clearable-input">
                              <input type="text" id="owner_midName" name="owner_midName" value="" class="form-control searchinput" placeholder="demo">
                              <label>Middle Name</label>
                           </div>
                           <div class="form-floating mb-3 clearable-input">
                              <input type="text" id="owner_lastName" name="owner_lastName" value="" class="form-control searchinput" placeholder="demo">
                              <label>Last Name</label>
                           </div>
                        </div>
                        <div class="">
                           <div class="input-group date" id="datepicker">
                              <input data-date-format="yyyy-mm-dd" type="text" class="form-control datepicker" name="owner_dob" id="owner_dob" placeholder="Enter your DOB" />
                        ...
                        <div class="mt-3">
                           ...
                           <div class="mt-1">
                              <select id="owner_Jurisdiction_country" name="owner_Jurisdiction_country[]" class="selectpicker countrypicker form-control" data-flag="true" data-live-search="true" multiple></select>
                           </div>
                        </div>
                        <div class="mt-3">
                           ...
                           <div class="mb-3">
                               ...
                               <select id="owner_residence_country"  name="owner_residence_country" class="selectpicker countrypicker form-control w-100" data-live-search="true" data-flag="true" >
                        ...
                        <div class="mt-3">
                           ...
                           <div class="form group mt-3">
                              ...
                              <select  id="owner_docIssueRegion" name="owner_docIssueRegion" class="selectpicker countrypicker form-control" data-live-search="true" data-flag="true" >
                        ...
                        <div class="mt-3">
                           ...
                           <div class="form-group d-flex doc-type mt-2">
                              <div class="passport d-flex align-items-center">
                                 <input type="radio" id="owner_passport" name="owner_idDocType" value="10" checked class="radio-btns"> Passport
                              </div>
                              <div class="aadhar d-flex align-items-center">
                                 <input type="radio" id="owner_aadhar" name="owner_idDocType" value="13" class="radio-btns"> Aadhar Card
                              </div>
                              <div class="passport d-flex align-items-center">
                                 <input type="radio" id="owner_IdCard" name="owner_idDocType" value="9" class="radio-btns"> Id Card
                              </div>
                           </div>
                        </div>
                        <div class="form group mt-3">
                           ...
                           <div class="form-floating mb-3 clearable-input">
                              <input type="text"  id="owner_IdNum" name="owner_IdNum" class="form-control searchinput" placeholder="demo">
                        ...
                        <div class="upl-doc">
                           <div class="upl-doc-inner">
                              ...
                              <input   id="ownerId_frontCopy" name="ownerId_frontCopy" type="file" value="" accept="image/jpg,image/jpeg,image/png,application/pdf" multiple="" style="position: absolute; width: 100%; height: 100%; opacity: 0; cursor: pointer;">
                           </div>
                           <div class="upl-doc-inner">
                              <div class="inner-doc"> 
                                 <div class="upld-main">
                              ...
                              <input  type="file" id="ownerId_BackCopy" name="ownerId_BackCopy" value="" accept="image/jpg,image/jpeg,image/png,application/pdf" multiple="" style="position: absolute; width: 100%; height: 100%; opacity: 0; cursor: pointer;">
                           </div>
                        </div>
                           ...
                           <div class="upld-btn-outer">
                              <div class="upld-btn-inner">
                                 <button  type="button" class="generate-btn">
                                    <input type="file" id="owner_addressproof" name="owner_addressproof" accept=".pdf,.jpg,.jpeg,.png" style="position: absolute; width: 100%; height: 100%; opacity: 0; cursor: pointer;">
                        ...
                        <div class="mt-3">
                           ...
                           <div class="row">
                              <div class="col-md-6 col-sm-6 mb-3">
                                 <select class="form-control" id="ownerDoc_type" name="ownerDoc_type">
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="input-group date" id="datepicker">
                                    <input data-date-format="yyyy-mm-dd" type="text" class="form-control datepicker" name="addProofIssuedate" id="addProofIssuedate" placeholder="Issue Date or Last Date of Billing Period" />
                                    <span class="input-group-append">
                                    <span class="input-group-text bg-light">
                                    <i class="bi bi-calendar-fill"></i>
                                    </span>
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="mb-3">
                                     ...
                                     <select  id="owner_addProof_country" name="owner_addProof_country" class="selectpicker countrypicker form-control" data-live-search="true" data-flag="true" > </select>
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="form-floating mb-3 clearable-input">
                                    ...
                                    <input type="text" id="owner_addressproof_state" name="owner_addressproof_state" class="form-control searchinput" placeholder="demo">
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="form-floating mb-3 clearable-input">
                                      <label>City</label>
                                    <input type="text"  id="owner_addressproof_city" name="owner_addressproof_city" class="form-control searchinput" placeholder="demo">
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="form-floating mb-3 clearable-input">
                                    ...
                                    <input type="text"  id="owner_addressproof_zipcode" name="owner_addressproof_zipcode"  pattern="\d*" maxlength="6"  oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control searchinput" placeholder="demo">
                              ...
                              <div class="col-md-12 col-sm-12">
                                 <div class="form-floating mb-3 clearable-input">
                                    ...
                                    <input type="text" id="owner_addressproof_Street" name="owner_addressproof_Street" class="form-control searchinput" placeholder="demo">
            ...
            <div class="modal-footer mt-5">
               <div class="footer-div-btn">
                  <button class="modal_btn_theme" id="submitOwnerForm">Submit</button>
                  <button class="btn bg-whitesmoke" id="cancelOwnerForm">Cancel </button>
               </div>
            </div>
         </div>
      </div>
