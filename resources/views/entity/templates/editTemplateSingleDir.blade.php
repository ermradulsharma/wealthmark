...
<div class="modal custom_modal" id="editSingle_Add-Director" style="display: block;">
         ...
         <div class="modal-box" style="max-width:850px;">
            <div class="modal-header">
               <div class="modal-icons">
                  ...
                  <span class="close-modal editcloseModal" id="editcloseModalSingle">
                  <i class="bi bi-x"></i>
                  </span>
               </div>
            ...
            <div class="modal-body text-start ">
               ...
               <form action="#" id="edit_Single_directorForm" style="width: 100%;" enctype="multipart/form-data">
                   @csrf

                  <div class="form-inner Individual scrollbar-style">
                       <input type="text" hidden="" name="pdId" id="singleDir_edit_pId" value="{{ $findCompDirector->id }}" class="form-control " placeholder="">
                     <input type="text" hidden="" name="partnerId" id="singleDir_edit_partnerId" value="{{ $findCompDirector->partnerId }}" class="form-control " placeholder="">
                     <input type="text" hidden="" id="singleDir_edit_directoTypeIndi" name="directoTypeIndi" value="{{ $findCompDirector->partnerType}}" class="form-control " placeholder="">
                     <div class="d-column">
                        <label class="label-text">Basic Information</label>
                        <div class="column3">
                           <div class="form-floating mb-3 clearable-input">
                              <input type="text" class="form-control searchinput" id="singleDir_edit_firstName" name="firstName" value="{{ $findCompDirector->firstName }}" placeholder="demo">
                              <label>First Name</label>
                           </div>
                           <div class="form-floating mb-3 clearable-input">
                              <input type="text" class="form-control searchinput" id="singleDir_edit_MidName" name="MidName" value="{{ $findCompDirector->MidName }}" placeholder="demo">
                              <label>Middle Name</label>
                           </div>
                           <div class="form-floating mb-3 clearable-input">
                              <input type="text" class="form-control searchinput" id="singleDir_edit_lastName" name="lastName" value="{{ $findCompDirector->lastName }}" placeholder="demo">
                        ...
                        <div class="">
                           <div class="input-group date" id="datepickerind">
                                ...
                                <input data-date-format="yyyy-mm-dd" type="date" class="form-control datepicker" id="singleDir_edit_indidate" name="indidob" value="{{ $findCompDirector->dob }}" placeholder="Enter your DOB">
                        ...
                        <div class="mt-3">
                           <div class="d-flex justify-content-between">
                              ...
                              <div class="multiple-text d-flex align-items-center">
                                 ...
                                 <input type="checkbox" id="singleDir_multipleCitizenship" checked class="multipleCitizenship radio-btns"> Multiple Citizenship
                              </div>
                           </div>

                           <div class="mt-1">
                              <select id="singleDir_edit_jurisCountry"  name="jurisCountry[]" data-flag="true" data-live-search="true"   multiple>

                                     @php
                                        $eachcntry = explode(',' , $findCompDirector->jurisCountry);
                                     @endphp
                        ...
                        <div class="mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                      <label class="label-text bg-whitesmoke p-1 text-center mb-3">Residential Address</label>
                                            <div class="mb-3">
                                                <label>Country of Residence</label>
                                           <select id="singleDir_edit_countryResidence" class="w-100" name="countryResidence" data-flag="true" data-live-search="true">
                                               @foreach($jocntry as $key => $value)
                                               <!--<img src="https://countryflagsapi.com/png/{{ $key }}" >-->
                                               <option value="{{ $key }}"     {{ $key == $findCompDirector->countryResidence ? "selected"  : "" }} >
                                               <span> {{ $value }}</span>
                                               </option>
                                               <!--<img src="https://countryflagsapi.com/png/{{ $key }}" >-->
                                               @endforeach
                           ...
                           <div class="mt-1 w-100">
                               <select id="singleDir_edit_Region_of_Issue" class="w-100" name="Region_of_Issue"  data-live-search="true" data-flag="true" >

                                 @foreach($jocntry as $key => $value)
                                          <!--<img src="https://countryflagsapi.com/png/{{ $key }}" >-->
                                          <option value="{{ $key }}" {{ ($key == $findCompDirector->idDocIssuedCountry) ? "selected" : "" }} >
                                          <span> {{ $value }}</span>
                                          </option>
                                          <!--<img src="https://countryflagsapi.com/png/{{ $key }}" >-->
                                    @endforeach
                        ...
                        <div class="mt-3">
                           ...
                           <div class="form-group d-flex doc-type mt-2">
                              <div class="passport d-flex align-items-center">
                                 <input type="radio" id="singleDir_edit_idDocTypePS" name="edit_idDocType" value="10" {{ ($findCompDirector->idDocType == 10) ? "checked" : "" }} class="radio-btns"> Passport
                              </div>

                              <div class="passport d-flex align-items-center">
                                 <input type="radio" id="singleDir_edit_idDocTypeID" name="edit_idDocType" value="9" {{ ($findCompDirector->idDocType == 9) ? "checked" : "" }} class="radio-btns"> Id Card
                              </div>
                           </div>
                        </div>
                        <div class="form group mt-3">
                           ...
                           <div class="form-floating mb-3 clearable-input">
                              <input type="text" class="form-control searchinput" id="singleDir_edit_idDocNum" value="{{ $findCompDirector->idDocNum }}" name="idDocNum" placeholder="demo">
                        ...
                        <div class="upl-doc">
                           <div class="upl-doc-inner">
                              ...
                              <input id="singleDir_edit_idDocUploadedFront" name="edit_idDocUploadedFront" value="{{ $findCompDirector->idDocUploadedFront }}" type="file" accept="image/jpg,image/jpeg,image/png,application/pdf" multiple="" style="position: absolute; width: 100%; height: 100%; opacity: 0; cursor: pointer;">
                            </div>
                           ...
                           <div class="upl-doc-inner">
                              ...
                              <input id="singleDir_edit_idDocUploadedBack" name="edit_idDocUploadedBack" value="{{ $findCompDirector->idDocUploadedBack }}" type="file" accept="image/jpg,image/jpeg,image/png,application/pdf" multiple="" style="position: absolute; width: 100%; height: 100%; opacity: 0; cursor: pointer;">
                           </div>

                        </div>
                        <div class="upl-doc">
                             <div class="upl-doc-inner preview-frontDocIndi">
                                <img width="100%" class="thumbnails" src="{{ url('storage/app/'.$findCompDirector->idDocUploadedFront) }}" alt="" title="" />
                            </div>
                             <div class="upl-doc-inner preview-backDocIndi">
                               <img width="100%" class="thumbnails" src="{{ url('storage/app/'.$findCompDirector->idDocUploadedBack) }}" alt="" title="" />
                            </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="modal-footer mt-5">
               <div class="footer-div-btn">
                  <button class="modal_btn_theme" id="updateSingleDirectorFormSubmit">Update</button>
                  <button class="btn bg-whitesmoke" id="editSingleDirectorCancel">Cancel </button>
               </div>
            </div>
...
// to close edit indivisual form
  ...
  $("#editcloseModalSingle, #editSingleDirectorCancel").click(function(){
           $("#editSingle_Add-Director").css({"display":"none"});
 });

 $("#updateSingleDirectorFormSubmit").click(function(){




   const pId = $("#singleDir_edit_pId").val();
   const partnerId = $("#singleDir_edit_partnerId").val();
   const directoTypeIndi = $("#singleDir_edit_directoTypeIndi").val();

   const firstName = $("#singleDir_edit_firstName").val();
   const MidName = $("#singleDir_edit_MidName").val();
   const lastName = $("#singleDir_edit_lastName").val();

   const indidate = $("#singleDir_edit_indidate").val();

   const jurisCountry = $("#singleDir_edit_jurisCountry").val();
   const countryResidence = $("#singleDir_edit_countryResidence").val();
   const Region_of_Issue = $("#singleDir_edit_Region_of_Issue").val();

   const idDocType = $("input[name='edit_idDocType']:checked").val();
   const idDocNum = $("#singleDir_edit_idDocNum").val();

 // const idDocUploadedFront = $("#edit_idDocUploadedFront").val();
   //   const idDocUploadedBack = $("#edit_idDocUploadedBack").val();

   const idDocUploadedBack = $("#singleDir_edit_idDocUploadedBack").attr('value');
   const idDocUploadedFront = $("#singleDir_edit_idDocUploadedFront").attr('value');
    ...
    //   alert("to submit indivisual form");
     ...
     // alert(pId+"/"+partnerId+"/"+directoTypeIndi+"/"+firstName+"/"+MidName+"/"+lastName+"/"+indidate+"/"+jurisCountry+"/"+countryResidence+"/"+Region_of_Issue+"/"+idDocType+"/"+idDocNum+"/"+idDocUploadedFront+"/"+idDocUploadedBack);
         ...
         var form_Data_singleDir = new FormData( $('#edit_Single_directorForm')[0]);
      // var form_data = new FormData(document.getElementById("editIndi_Add-Director"));

                     //   form_Data_singleDir.append('user_id' , user_id);
                     //   form_Data_singleDir.append('status' , indivisualSubmitStatus);
                 //   form_Data_singleDir.append('partnerType' , partnerType);
                     //   form_Data_singleDir.append('dob' , date);

                       form_Data_singleDir.append('idDocUploadedFront_old' , idDocUploadedFront);
                      form_Data_singleDir.append('idDocUploadedBack_old' , idDocUploadedBack);


                             if((firstName.length< 1) || (lastName.length< 1) || (indidate.length< 1) || (document.getElementById('singleDir_edit_jurisCountry').selectedIndex < 0) || (document.getElementById('singleDir_edit_countryResidence').selectedIndex < 0) || (document.getElementById('singleDir_edit_Region_of_Issue').selectedIndex < 0 )  || idDocType.length< 1 || idDocNum.length< 1 || idDocUploadedFront.length< 1 || idDocUploadedBack.length< 1  ){

                                  $("#editSingle_Add-Director .msgValidErrIndisul").html('<span style="color:red"> All fields are mandatory! </span>');
                                  setTimeout(function () {
                                                          $("#editSingle_Add-Director .msgValidErrIndisul").html('');
                                                      }, 1000);
                           }else{
                                 //  alert("Fields are validaed!");
                                                 	...
                                                 	$.ajax({
                                                         ...
                                                         url: "<?php echo url('api/UpdateSingleDirector');  ?>",
                                                          processData: false,
                                                          contentType: false,
                                                         enctype : 'multipart/form_Data_singleDir',

                                                          data : form_Data_singleDir,
