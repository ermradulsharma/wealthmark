        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item show-mob">
                <a class="nav-link collapsed" href="{{ url(app()->getLocale()) }}/user/dashboard">
                    ...
                    <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/dashboard.svg') }}" class="breadcrumb-icon" alt="">
            ...
            <li class="nav-item show-mob">
                <a class="nav-link collapsed" href="{{ url(app()->getLocale()) }}/user/security">
                    <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/security.svg') }}" class="breadcrumb-icon" alt="">
            ...
            <li class="nav-item show-mob">
               ...
               <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/identification.svg') }}" class="breadcrumb-icon" alt="">
            ...
            <li class="nav-item show-mob">
                <a class="nav-link collapsed" href="{{ url(app()->getLocale()) }}/user/payment">
                 <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/payment.svg') }}" class="breadcrumb-icon" alt="">
            ...
            <li class="nav-item mobile-tab-hide-listing">
               ...
               <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/order.svg') }}" class="breadcrumb-icon" alt=""><span>Orders</span>
            ...
            <li class="nav-item">
              ...
              <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/lending.svg') }}" class="breadcrumb-icon" alt="">
                    <span>Lending</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url(app()->getLocale()) }}/user/market">
                   <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/market.svg') }}" class="breadcrumb-icon" alt="">
                    <span>Market</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url(app()->getLocale()) }}/user/referral">
                    <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/refferal.svg') }}" class="breadcrumb-icon" alt="">
                    <span>Refferal</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url(app()->getLocale()) }}/user/reward-center">
                   <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/reward-centre.svg') }}" class="breadcrumb-icon" alt="">
                    <span>Reward Center</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url(app()->getLocale()) }}/user/task-center">
                   <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/task-centre.svg') }}" class="breadcrumb-icon" alt="">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ url(app()->getLocale()) }}/user/settings">
                    <img src="{{ asset('assets/img/dashboard-icons/sidebar-icons/setting.svg') }}" class="breadcrumb-icon" alt="">
                    <span>Settings</span>
                </a>
            </li>
