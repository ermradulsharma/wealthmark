...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <body class="bg-white Buyer_from_sell_tab ">
             ...
             <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="bg-light-theme rounded order-noti-txt">
                        <h5 class="mb-3">Transfer payment to Seller</h5>
                        <span>
                         ...
                         <div class="header" id="my-div2">
                          ...
                          @if(!empty($seller_details))
                           <div class="chat-room scrollbar-style">
                            ...
                            <input type="text" name="chat_message_{{$seller_details->id}}" id="chat_message_{{$seller_details->id}}" class="form-control chat_message border-0" placeholder="Type messages here..."/>
               ...
               <div class="modal-body">
                  ...
                  <div class="payment-confirmation-modal" >
                     ...
                     <div class="upload-proof-block mb-3">
                        ...
                        <div class="text">
                           Upload and send at least 1 proof of payment to the seller. Supported file formats include jpg, jpeg, png
                        </div>
                     </div>
     ...
     <section class="bg-light-blue" {{ isset($_SESSION['buyer_confirmation_status']) ? "style=display:block" : "style=display:none"}}>
          <div class="container">
               <div class="row">
                   ...
                   <div class="bg-white py-4 rounded px-4 mb-3">
                       ...
                       <a href="javascript:void(0)" class="btn-yellow border-0 d-inline-flex me-4 align-items-center mb-3" data-bs-toggle="modal" data-bs-target="#have-a-question">
                            <div class="method-name me-3">
                                <i class="bi bi-coin me-1"></i>    Have A Question
                            </div>
                       ...
                       <a href="javascript:void(0)" class="btn-blue border-0 d-inline-flex me-4 align-items-center" data-bs-toggle="modal" data-bs-target="#paid-order-cancelled">
                            <div class="method-name me-3">
                                <i class="bi bi-coin me-1"></i>    I paid but the order has been cancelled
                            </div>
                            <i class="bi bi-arrow-right"></i>
                       </a>
            ...
            if($('#myCheckbox').is(":checked")){
               ...
               var checkbox = $("#myCheckbox").prop("checked");
                ...
                $.ajax({
                    ...
                    contentType: false,
                    success: function(data){
                        $(".if_paymentIssue").css("display","none");
        ...
        // console.log('else if 1-1-1');
         // alert('3');
            offtimer2 = setInterval(function() {
                ...
                //     $('#timer').html('<span id="Timerstatus">95% of the Seller\'s order have been completed within </span><span style="border: 1px solid rgba(248,165,50,1);border-radious:8px; padding:4px; font-weight:bold; background-color:rgb(250 173 40);">' + minutes +' minutes</span>' + ' : ' + '<span style="border: 1px solid rgba(248,165,50,1);border-radious:8px;padding:4px;font-weight:bold; background-color: rgb(250 173 40);">' + (seconds < 10 ? '0' : '') + seconds + ' seconds</span>');
                // }
        ...
        return new Promise(function(resolve, reject) {
            ...
            $.get('{{ route('check-order-status', ['id' => ':id']) }}'.replace(':id', order_id), function(response) {
                ...
                if (response.status.order_status == 1 && response.status.buyer_confirmation_status == null && response.status.seller_confirmation_status == null && response.status.order_accept_action == 1) {
                    // order accepted
                   //console.log(localStorage.getItem("previouStatus"));
