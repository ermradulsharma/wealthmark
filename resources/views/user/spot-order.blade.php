   ...
   <head>
      ...
      <style>
         ...
         @media (max-width: 575px){
            .lf-select_coin-to.max-width-200px {
               margin-bottom: 15px;
        }
}
      </style>
         ...
         <div class="container-fluid p-0">
            <div class="bg-light-blue p-3 w-100">
               <div class="bg-white shadow-none border-0 px-4 py-3 mb-2">
                  ...
                  <h2 class="fw-bold mb-0">Open Orders</h2>
               </div>
                <div class="bg-white shadow-none border-0 px-4 py-3 mb-2">
                     ...
                     <div    class="d-sm-flex">
                         <div class="me-2">
                            <div class="label position-relative">
                               <span class="payment-transation-txt  pe-5">Filter</span>
                                  ...
                                  <div class="lf-select_coin-to max-width-200px" id="earn-search-coin-filter">
                                     ...
                                     <div class="wm-dropdown-div  wm-dropdown-div-open" style="display: none;">
                                        <ul role="listbox" class="wm-dropdown-list wm-dropdown-list-css">
                                           <li role="option" id="01" title="01" class="wm-dropdown-optn-item "
                                           ...
                                           <li role="option" id="02" title="02" class="wm-dropdown-optn-item "
                                              onclick="changeSrc2(this.id)" style="display: list-item;">
                                              <div class="wm-dropdown-optn-item-inner">
                                                 <div class="wm-dropdown-optn-item-div">
                                           ...
                                           <li role="option" id="03" title="03" class="wm-dropdown-optn-item "
                                           ...
                                           <li role="option" id="04" title="04" class="wm-dropdown-optn-item "
                                              onclick="changeSrc2(this.id)" style="display: list-item;">
                                              <div class="wm-dropdown-optn-item-inner">
                                                 <div class="wm-dropdown-optn-item-div">
                                           ...
                                           <li role="option" id="05" title="05" class="wm-dropdown-optn-item "
                                              onclick="changeSrc2(this.id)" style="display: list-item;">
                         ...
                         <div class="me-2">
                            <div class="label position-relative">
                               <span class="payment-transation-txt pe-5">Pair</span>
                               <div class="earn-search-div-main">
                                  <div class="lf-select_coin-to max-width-200px" id="earn-search-coin-filter">
                                     <div class=" coin-swap-from m-0 min-height-40px">
                                        <input type="text" value="16" class="lf-select-coin-to-input">
                                     ...
                                     <div class="wm-dropdown-div  wm-dropdown-div-open" style="display: none;">
                                        ...
                                        <ul role="listbox" class="wm-dropdown-list wm-dropdown-list-css">
                                           <li role="option" id="06" title="06" class="wm-dropdown-optn-item "
                                              onclick="changeSrc2(this.id)" style="display: list-item;">
                                              <div class="wm-dropdown-optn-item-inner">
                                                 <div class="wm-dropdown-optn-item-div">
                                                    <div class="wm-dropdown-optn-item-txt">All</div>
                                           ...
                                           <li role="option" id="07" title="07" class="wm-dropdown-optn-item "
                                              onclick="changeSrc2(this.id)" style="display: list-item;">
                                              <div class="wm-dropdown-optn-item-inner">
                                                 <div class="wm-dropdown-optn-item-div">
                                           ...
                                           <li role="option" id="08" title="08" class="wm-dropdown-optn-item "
                                              onclick="changeSrc2(this.id)" style="display: none;">
                                              <div class="wm-dropdown-optn-item-inner">
                                                 <div class="wm-dropdown-optn-item-div">
                                                    <div class="wm-dropdown-optn-item-txt">NULS/BTC</div>
                                                 </div>
                                              </div>
                                           </li>
                                           <li role="option" id="09" title="09" class="wm-dropdown-optn-item "
                                              onclick="changeSrc2(this.id)" style="display: list-item;">
                                              <div class="wm-dropdown-optn-item-inner">
                                                 <div class="wm-dropdown-optn-item-div">
                                                    <div class="wm-dropdown-optn-item-txt">NEO/BTC</div>
                                                 </div>
                                              </div>
                                           </li>
                                           <li role="option" id="10" title="10" class="wm-dropdown-optn-item "
                                              onclick="changeSrc2(this.id)" style="display: list-item;">
                                              <div class="wm-dropdown-optn-item-inner selected">
                                                 <div class="wm-dropdown-optn-item-div">
                                                    <div class="wm-dropdown-optn-item-txt">LINK/BTC</div>
                                                 </div>
                                              </div>
                                           </li>
                                           <li role="option" id="11" title="11" class="wm-dropdown-optn-item "
                                              onclick="changeSrc2(this.id)" style="display: none;">
                                              <div class="wm-dropdown-optn-item-inner">
                                                 <div class="wm-dropdown-optn-item-div">
                                                    <div class="wm-dropdown-optn-item-txt">IOTC/BTC</div>
                                                 </div>
                                              </div>
                                           </li>
                                        </ul>
                         ...
                         <div class="me-2">
                            <div class="label position-relative">
                               <span class="payment-transation-txt pe-5">Side</span>
                               <div class="earn-search-div-main">
                                  <div class="lf-select_coin-to max-width-200px" id="earn-search-coin-filter">
                                     <div class=" coin-swap-from m-0 min-height-40px">
                                        <input type="text" value="16" class="lf-select-coin-to-input">
                                     ...
                                     <div class="wm-dropdown-div  wm-dropdown-div-open" style="display: none;">
                                        <ul role="listbox" class="wm-dropdown-list wm-dropdown-list-css">
                                           <li role="option" id="12" title="12" class="wm-dropdown-optn-item "
                                              onclick="changeSrc2(this.id)" style="display: list-item;">
                                              <div class="wm-dropdown-optn-item-inner">
                                                 <div class="wm-dropdown-optn-item-div">
                                                    <div class="wm-dropdown-optn-item-txt">All</div>
                     ...
                     <div class=" pb-1 mt-2 mb-2"></div>
                     <div class="bg-white col-md-12 shadow-none border-0">
                           ...
                           <table class="table table-hover tbl-to-div">
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td>50 Coin</td>
                                    <td>Buy</td>
                                    <td><span class="bg-danger p-1 rounded d-inline-block min-width-80px text-center text-white"> Success</span></td>
                                    <td class="arrow-open">
                                 ...
                                 <tr>
                                    ...
                                    <td>50 Coin</td>
                                    <td>Buy</td>
                                    <td><span class="bg-whitesmoke p-1 rounded d-inline-block min-width-80px text-center"> Success</span></td>
                                    <td class="arrow-open">
                                       <span class="expand-row">
                                       <i class="bi bi-chevron-down"></i>
                                       </span>
                                 ...
                                 <tr>
                                    ...
                                    <td>50 Coin</td>
                                    <td>Buy</td>
                                    <td><span class="bg-green-light p-1 rounded d-inline-block min-width-80px text-center"> Success</span></td>
                                    <td class="arrow-open">
                                       <span class="expand-row">
                                       <i class="bi bi-chevron-down"></i>
                                       </span>
