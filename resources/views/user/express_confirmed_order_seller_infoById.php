    ...
    function start() {
        ...
        if (orderStatus == 1 && buyer_confirmation_status == 0  && order_accept_action == 1  ) {
            ...
            offtimer = setInterval(function() {
                ...
                // if (counter >= 0) {
                //     $('#timer').html('');
                //      $('#timer').html('<span id="Timerstatus">95% of the buyer\'s order have been completed within </span><span style="border: 1px solid rgba(248,165,50,1);border-radious:8px;padding:4px;font-weight:bold; background-color:rgb(250 173 40);">' + minutes +' minutes</span>' + ' : ' + '<span style="border: 1px solid rgba(248,165,50,1);border-radious:8px;padding:4px;font-weight:bold; background-color: rgb(250 173 40);">' + (seconds < 10 ? '0' : '') + seconds + ' seconds</span>');
                // }
        ...
        // else if(orderStatus == 1 && seller_confirmation_status == 1 && order_accept_action == 1) {
        ...
        // console.log('else if 6');
            ...
            offtimer1 = setInterval(function() {
                ...
                // if (counter >= 0) {
                //     $('#timer').html('');
                //      $('#timer').html('<span id="Timerstatus">You have to completed the order within</span> <span style="border: 1px solid rgba(248,165,50,1);border-radious:8px;padding:4px;font-weight:bold; background-color:rgb(250 173 40);">' + minutes +' minutes</span>' + ' : ' + '<span style="border: 1px solid rgba(248,165,50,1);border-radious:8px;padding:4px;font-weight:bold; background-color: rgb(250 173 40);">' + (seconds < 10 ? '0' : '') + seconds + ' seconds</span>');
                // }
