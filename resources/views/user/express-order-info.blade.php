...
// 		}
		...
		html2 += "<div class='avatar-wrapper avatar-big'>"+user_image+"</div><input type='hidden' value='"+data.data.id+"' id='to_user_id'><span class='name'><span>"+data.data.name+"</span><span class='verified text-green'><i class='bi bi-patch-check-fill'></i></span><div class='fs-12'>"+last_seen+"</div></span>";
