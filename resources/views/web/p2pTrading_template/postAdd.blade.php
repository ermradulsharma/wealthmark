  ...
  editor.model.change( writer => {
    ...
    //    console.log(methodIds);
     ...
     // SUBMIT ADS POST
        ...
        $.ajax({
            type: 'POST',
            url: '{{ route('SubmitPostAds') }}',
            cache: false,
            beforeSend: function(){ $("#SubmitPostAds").text("Post Getting Submited."); $("#SubmitPostAds").css("pointer-events","none"); },
            data: {
                '_token': "{{ csrf_token() }}",
                'ordertype' : ordertype ,
