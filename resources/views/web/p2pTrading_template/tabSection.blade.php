            ...
            <div class="buy-sell-tab-section">
                    <div class="first position-relative">
                                <label class="switch-btn">
                                    ...
                                    <div class="s-slider round">
                                        <span class="s-slider_text">
                                            <span class="off nav-link buy"  <?php if(url()->current()==url(app()->getLocale().'/p2p-trading/buy')){echo'style="background-color: green!important;color: white;"';} ?> href="{{ url(app()->getLocale().'/p2p-trading/buy') }}" id="p2p-trading-buy-tab" >Buy</span>
                                            <span class="on nav-link sell"  <?php if((url()->current()==url(app()->getLocale().'/p2p-trading')) || (url()->current()==url(app()->getLocale().'/p2p-trading/bmk')) || (url()->current()==url(app()->getLocale().'/p2p-trading/btc')) || (url()->current()==url(app()->getLocale().'/p2p-trading/eth')) ){echo'style="background-color: red!important;color:white"';} ?>  href="{{ url(app()->getLocale().'/p2p-trading') }}" id="p2p-trading-sell-tab">Sell</span>
                                        </span>
                                    </div>
                                </label>
                                ...
                                <div class="p2p-filter-div">
                                    ...
                                    <svg viewBox="0 0 24 24" fill="none" id="open-p2p-form"><path d="M3 3v4.5L8.4 13v7h3.3l3.2-3.2V13l5.5-5.5V3H3zm15.4 3.7l-5.5 5.5V16l-2 2h-.5v-5.8L5 6.7V5h13.5v1.7h-.1z" fill="currentColor"></path></svg>
                                </div>
                    </div>
               <div class="second">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 header-div flex-div justify-content-between position-relative py-2">
                     ...
                     <svg viewBox="0 0 24 24" fill="none" class="p2p-close-slide-div"><path d="M6.697 4.575L4.575 6.697 9.88 12l-5.304 5.303 2.122 2.122L12 14.12l5.303 5.304 2.122-2.122L14.12 12l5.304-5.303-2.122-2.122L12 9.88 6.697 4.575z" fill="currentColor"></path></svg>
                </div>
                            ...
                            <div class="lf-select_coin-to bg-light-blue">
                                             ...
                                             <div class="lf-select-coin-to-active-div">
                                                <div class="wm-dropdown-optn-item-div">
                                                   ...
                                                   <div class="wm-dropdown-optn-item-txt">{{$allcurrency[0]->name}}</div>
                                                </div>
                                             </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 d-flex align-items-center p-0">
                    <div class="position-relative max-width-150px ">
                        ...
                        <span class="yellow-text" id="block-tab-trading-filter-btn">
                           ...
                           <svg  viewBox="0 0 24 24" fill="none" ><path fill-rule="evenodd" clip-rule="evenodd" d="M12.11 12.178L16 8.287l1.768 1.768-5.657 5.657-1.768-1.768-3.889-3.889 1.768-1.768 3.889 3.89z" fill="currentColor"></path></svg>
                        </span>
                ...
                <div class="position-relative max-width-150px">
                    ...
                    <span class="bg-whitesmoke" id="block-tab-trading-refresh-btn">
                        <svg  viewBox="0 0 24 24" fill="none" class="refresh-svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M19.997 12.21a8.161 8.161 0 000-.42v.42zm-4.463 3.327l-2.608-2.608h7.07V20l-2.341-2.342A8.003 8.003 0 014.252 14h3.164a5.001 5.001 0 008.118 1.537zM19.747 10A8.003 8.003 0 006.343 6.343L4.001 4v7.071h7.07L8.466 8.464A5.001 5.001 0 0116.585 10h3.162zM4 12L4 11.845v.31A8.126 8.126 0 014 12z" fill="currentColor"></path></svg>
                        <span>   Refresh </span>
                    </span>
                    <div class="ul-dropdown">
                        <ul>
    ...
    <section class="openRefreshModalExapnd" id="openRefreshModalExapnd">
            <div class="container">
                  <div class="header-div flex-div justify-content-between position-relative py-2">
                     <div class="fs-6 text-black">Filter </div>
                     <svg viewBox="0 0 24 24" fill="none" class="p2p-close-refresh-div cursor-pointer"><path d="M6.697 4.575L4.575 6.697 9.88 12l-5.304 5.303 2.122 2.122L12 14.12l5.303 5.304 2.122-2.122L14.12 12l5.304-5.303-2.122-2.122L12 9.88 6.697 4.575z" fill="currentColor"></path></svg>
                </div>
                <div>
                    <ul>
                            <li>
