                    ...
                    <div class="dashboard-card-body">
                                ...
                                <ul class="nav nav-pills my-1 border-bottom" id="pills-tab" role="tablist">
                                    <li class="nav-item w-50" role="presentation">
                                        <button class="nav-link active w-100" id="Buy-express-tab" data-bs-toggle="pill" data-bs-target="#Buy-express" type="button" role="tab" aria-controls="Buy-express" aria-selected="true">Buy</button>
                                    </li>
                                    <li class="nav-item w-50" role="presentation">
                                        <button class="nav-link w-100" id="sell-express-tab" data-bs-toggle="pill" data-bs-target="#sell-express" type="button" role="tab" aria-controls="sell-express" aria-selected="false">Sell</button>
                                    </li>
                                </ul>
                            ...
                            <div class="bS-crypto-div-inp-div">
                              ...
                              <div class="bS-crypto-div-open-list" id="selected_crypto">
                                ...
                                <svg viewBox="0 0 24 24" fill="none" class="bS-crypto-div-open-list-svg">
                                 ...
                                 <!--   <div class="tab-pane fade" id="sell-express" role="tabpanel" aria-labelledby="sell-express-tab">-->
                                 <!--       <div class="crypto-right-inner flex-column">-->
                                 <!--           <div class="flex-1">-->
                                 <!--               <div class="field crypto-rght-first-box">-->
...
$(".confirmPay_24052023").click(function(){
