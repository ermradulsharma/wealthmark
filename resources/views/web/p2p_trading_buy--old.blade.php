               ...
               <div class="wm-custom-modal-body bg-light-blue py-2 px-3 max-height-600px scrollbar-style">
                  <div class="bg-white p-2 mb-2 " id="payment-method-content-left">
                     <input type="hidden" class="postID" name="postID" value="">
                        ...
                        <tr>
                            <td class=""><div class="buy_modal_lbl"> Name  :  </div>
                            </td>
                            <td>
                        ...
                        <tr>
                           ...
                           <span class="buyer_order_completion" style="white-space: normal;"></span>
                        </div>
                            </td>
                        </tr>
                         <tr>
                         ...
                         <tr>
                            ...
                            <td>
                                 <div class="buy_modal_value">
                              <span class="total-crypto-coin"></span><small>BMK</small> - <span class="crypto-coin-type"></span>
                           </div>
                            </td>
                        </tr>
                         <tr>
                      ...
                      <div class="record-section bg-whitesmoke flex-column  scrollbar-style">
                        ...
                        <div class="buy_modal_value w-100 flex-div fs-12">
                            ...
                            <span class="buyer_countryparty_conditions p-3">
                           ...
                           <form action="javascript:void(0);">
                              ...
                              <div class="mb-3 mt-1 bg-light-blue p-2">
                                <div class="table-responsive mb-2 bg-white" id="addHiddenValues" >
                                 ...
                                 <a href="javascript:void(0);" class="btn-yellow d-inline-block shadow-none set-pyment-mthd"  id="" data-target-modal="payMethod" >
         ...
         function Buy_bmk(id){
               ...
               //  alert(id);  
                if (parseInt(localStorage.getItem('timerValue'))  == 0){
                   ...
                   $(".set-pyment-mthd").attr('id',ads_order_id);
