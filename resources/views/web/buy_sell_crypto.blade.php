      ...
      <div class="crypto-right-inner-main mt-0">
         ...
         <div class="dashboard-card-body">
                        ...
                        <li class="nav-item w-50" role="presentation">
                            <button class="nav-link active w-100" id="pills-spot-tab" data-bs-toggle="pill" data-bs-target="#pills-spot" type="button" role="tab" aria-controls="pills-spot" aria-selected="true">Buy</button>
                        </li>
                        <li class="nav-item w-50" role="presentation">
                            <button class="nav-link w-100" id="pills-p2p-tab" data-bs-toggle="pill" data-bs-target="#pills-p2p" type="button" role="tab" aria-controls="pills-p2p" aria-selected="false">Sell</button>
                        </li>
                        </ul>
    ...
    <span>
      ...
      <div class="wm-custom-modal-max-height">
        <div class="search-fillter-div">
          ...
          <!--  <div id="currency-2" class="custom-modal-drpdn" onClick="select_currency(this.id)">-->
          <!--  <div class="custom-modal-drpdn-inner">-->
          <!--    <div class="d-flex">-->
          ...
          <!--  </div>-->
          <!--</div>-->
          <!-- <div id="currency-3" class="custom-modal-drpdn" onClick="select_currency(this.id)">-->
          <!--  <div class="custom-modal-drpdn-inner">-->
          <!--    <div class="d-flex">-->
          <!--      <img src="{{ asset('img/87496d50-2408-43e1-ad4c-78b47b448a6a.png') }}" class="custom-modal-drpdn-img-1">-->
          <!--      <div class="custom-modal-drpdn-img">-->
          <!--        <div class="custom-modal-drpdn-title">USD</div>-->
          <!--        <div class="custom-modal-drpdn-subtitle">USA</div>-->
          <!--      </div>-->
          <!--    </div>-->
          ...
          <!--<div id="currency-4" class="custom-modal-drpdn" onClick="select_currency(this.id)">-->
          <!--  <div class="custom-modal-drpdn-inner">-->
          <!--    <div class="d-flex">-->
          <!--      <img src="{{ asset('img/87496d50-2408-43e1-ad4c-78b47b448a6a.png') }}" class="custom-modal-drpdn-img-1">-->
          <!--      <div class="custom-modal-drpdn-img">-->
          <!--        <div class="custom-modal-drpdn-title">JPY</div>-->
          <!--        <div class="custom-modal-drpdn-subtitle">Japanese Yen</div>-->
          <!--      </div>-->
          <!--    </div>-->
          ...
          <!--  <div id="currency-5" class="custom-modal-drpdn" onClick="select_currency(this.id)">-->
          <!--  <div class="custom-modal-drpdn-inner">-->
          <!--    <div class="d-flex">-->
          <!--      <img src="{{ asset('img/87496d50-2408-43e1-ad4c-78b47b448a6a.png') }}" class="custom-modal-drpdn-img-1">-->
          <!--      <div class="custom-modal-drpdn-img">-->
          <!--        <div class="custom-modal-drpdn-title">EURO</div>-->
          <!--        <div class="custom-modal-drpdn-subtitle">European Union</div>-->
          <!--      </div>-->
          <!--    </div>-->
...
$(".pg-option").click(function () {
 ...
 <script>
                ...
                $("#selected_crrency").click(function() {
                ...
                $("#selected_crypto").click(function() {
                $(".hide").addClass("custom-modal-bck-bg").removeClass("hide");
         ...
         function count_currency(count_currency){
      ...
      function count_crypto(amountToBuy){
...
<script>
$("#selectPaymntTobuy_crypto").click(function(){
  //  alert();
...
// }else{
     ...
     if( !$("#amount").val() || !$("#result").val()){
            if( !$("#amount").val()){
            $("#ocbs-guide-step1").css({'border' : '1px solid red'});
            // $("#ocbs-guide-step1 span").text('Spend field cannot be blanked!');

            }
            if( !$("#result").val() ){
            $("#ocbs-guide-step2").css({'border' : '1px solid red'});
...
$(".backToselection_forTrade").click(function(){
    ...
    if (parseInt(localStorage.getItem('timerValue'))  == 0) {
        ...
        if( ($(".pg-option.active input[name='cryptoTYPE']").length > 0) && ($(".pg-option.active input[name='cryptoVAL']").length > 0) && ($(".pg-option.active input[name='paymentMethodType']").length > 0) && ($(".pg-option.active input[name='paymentMethodId']").length > 0)) {
              ...
              $.ajax({
                    ...
                    type: 'get',
                    url: '{{  url(app()->getLocale()."/buy-sell-trade") }}',
                    data: {
                    ...
                    console.log(data.order_data);
                      ...
                      location.href = '{{  url(app()->getLocale()."/user/confirmed-order-info") }}';

                       // location.href = '{{  url(app()->getLocale()."/express_confirmed_order_buyer_info") }}';
