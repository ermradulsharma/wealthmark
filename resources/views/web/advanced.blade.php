...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <body class="bg-white">
    ...
    <section>
        <div class="container">
            <div class="row align-items-center p-2">
             <div class="col-lg-6 col-md-12 col-sm-12  order-lg-last text-center">
                   <img src="{{ asset('img/advanced/welcome-to-wm.png') }}" class="img-fluid w-100 animated max-width-450px" alt="">
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="sec-title text-left mb-2">

                            <h2 class="heading-h2">Welcome to Wealthmark <span class="yellow-text"> Advanced Cryptocurrency </span> Solutions</h2>
	...
	<section class="Why-advanced bg-light-blue">
		<div class="container">
            ...
            <div class="sec-title text-left">
                            ...
                            <h2 class="heading-h2">Wealthmark Advanced Exclusive Services</h2>
				...
				<div class="col-md-6 col-lg-4">
					<div class="single-service">
						<div class="content">
							...
							<div class="text">Mauris volutpat urna tristique finibus iaculis. Morbi facilisis, justo eu vulputate elementum, est augue tincidunt ante, sed efficitur leo ligula vel velit.</div>
						<div class="mt-4">	<a href="#" class="btn-blue">Learn More</a></div>
						</div>
    ...
    <div class="container">
        <div class="row">
            <div class="sec-title text-left">
                            <span class="title">Welcome to Wealthmark</span>
                            <h2 class="heading-h2">Top Cryptocurrency Prices by Market Cap</h2>
