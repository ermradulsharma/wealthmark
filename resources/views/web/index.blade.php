...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/wealthmark_new/css/style_index.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/css_template/all_pages.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/css_template/footer.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/css/css_template/header.css') }}">
        ...
        <div class="container-fluid  text-center">
            <div class="sign-up-block mt-2">
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item mb-0"><a href="{{ url(app()->getLocale(), 'register') }}"
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                    <div class="needhelp_inner">
                        <div class="need_thumb">
                            <img src="{{ asset('assets/wealthmark_new/img/icon-chat-support.svg') }}"
                ...
                <div class="col-lg-4">
                    <div class="needhelp_inner">
                        <div class="need_thumb">
                            <img src="{{ asset('assets/wealthmark_new/img/faqs.svg') }}" class="img-fluid"
                ...
                <div class="col-lg-4">
                    <div class="needhelp_inner">
                        <div class="need_thumb">
                            <img src="{{ asset('assets/wealthmark_new/img/blog.svg') }}" class="img-fluid"
