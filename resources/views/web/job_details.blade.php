...
:root {
 ...
 --level-button: #5052d5;
 --button-color: #fff;
  --heading-color: #263674;
}

.dark-mode {
 --body-bg-color: #13131a;
...
.wrapper.detail-page .job-overview-cards  , .wrapper.detail-page .job-explain{
    margin-top:70px;
}
.btn-back-div{
       position: absolute;
 ...
 .drop-zone {
    ...
    #apply_job_form_modal  .form-floating>label{
 ...
 <body>
     ...
     <!--<section class="bg-light-blue jobs-details">-->
     <!--    <div class="container">-->
     <!--        ss-->
     <!--    </div>-->
     <!--</section>-->
 ...
 <div class="wrapper scrollbar-style">
  <div class="search-menu">
   <div class="search-bar">
    ...
    <div class="search item">Product Designer
     <svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x">
   ...
   <div class="search-location">
    <svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-map-pin">
   ...
   <div class="search-job">
    <svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-briefcase">
     <rect x="2" y="7" width="20" height="14" rx="2" ry="2" />
     <path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16" /></svg>
    <input type="text" placeholder="Job Type">
   </div>
   <div class="search-salary">
    <svg viewBox="0 0 24 24"  stroke="currentColor" fill="currentColor" stroke-width=".4">
  ...
  <div class="main-container">
   ...
   <!----------------------------jobs main section--------------------------->
     ...
     <div class="searched-sort">Sort by: <span class="post-time">Newest Post </span>
       <span class="menu-icon">▼</span>
        ...
        <div class="job-cards">
             <div class="job-card">
               <div class="job-card-header">
                 <svg viewBox="0 -13 512 512"  style="background-color:#2e2882">
                   <g fill="#feb0a5">
               ...
               <div class="job-card-subtitle"> The User Experience Designer position exists to create compelling and digital user experience through excellent design... </div>
               ...
               <div class="job-card-buttons">
                 <button class="search-buttons card-buttons">I'm interested</button>
        ...
        <div class="job-overview">
            <div class="btn-back-div">
                <a href="javascript:void(0)" id="back_to_jobs" class="btn-default">Back to Jobs</a>
            </div>
            <div class="job-overview-cards">
                 ...
                 <div class="job-card overview-card">
                   <div class="overview-wrapper">
                     ...
                     <div class="overview-detail">
                       <div class="job-card-title">UI / UX Designer shubham</div>
                       <div class="job-card-subtitle"> 2972 Westheimer Rd. Santa Ana. </div>
                     </div>
                     <svg class="heart"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
               ...
               <div class="job-overview-card">
                 <div class="job-card overview-card">
                   <div class="overview-wrapper">
                     <svg  viewBox="0 0 32 32" style="background-color:#f76754">
                       <path  d="M0 .5h4.2v23H0z" fill="#042b48" data-original="#212121" />
                       <path  d="M15.4.5a8.6 8.6 0 100 17.2 8.6 8.6 0 000-17.2z" fill="#fefefe" data-original="#f4511e" />
                     </svg>
                     <div class="overview-detail">
                       <div class="job-card-title">Sr. Product Designer</div>
                       <div class="job-card-subtitle"> 1901 Thornridge Cir.Shiloh, Hawaii. </div>
                     </div>
                     <svg class="heart"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
                       <path d="M20.8 4.6a5.5 5.5 0 00-7.7 0l-1.1 1-1-1a5.5 5.5 0 00-7.8 7.8l1 1 7.8 7.8 7.8-7.7 1-1.1a5.5 5.5 0 000-7.8z" />
                     </svg>
               ...
               <div class="job-overview-card">
                 <div class="job-card overview-card">
                   <div class="overview-wrapper">
                     <svg  viewBox="0 0 512 512" fill="#fff" style="background-color:#55acee">
                     ...
                     <div class="overview-detail">
                       ...
                       <div class="job-card-subtitle"> 414 Parker Rd. Allentown, New york </div>
                     </div>
                     <svg class="heart"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
                       <path d="M20.8 4.6a5.5 5.5 0 00-7.7 0l-1.1 1-1-1a5.5 5.5 0 00-7.8 7.8l1 1 7.8 7.8 7.8-7.7 1-1.1a5.5 5.5 0 000-7.8z" />
                     </svg>
               ...
               <div class="job-overview-card">
                 <div class="job-card overview-card">
                   <div class="overview-wrapper">
                     <svg viewBox="0 0 24 24"  fill="#fff" style="background-color:#1e1f26">
                     ...
                     <div class="overview-detail">
                       ...
                       <div class="job-card-subtitle"> 4517 Washington Ave. Syracuse. </div>
                     </div>
                     <svg class="heart"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
                       <path d="M20.8 4.6a5.5 5.5 0 00-7.7 0l-1.1 1-1-1a5.5 5.5 0 00-7.8 7.8l1 1 7.8 7.8 7.8-7.7 1-1.1a5.5 5.5 0 000-7.8z" />
                     </svg>
               ...
               <div class="job-overview-card">
                 <div class="job-card overview-card">
                   <div class="overview-wrapper">
                     <svg viewBox="0 0 24 24"  style="background-color:#ffe80f">
                     ...
                     <div class="overview-detail">
                       <div class="job-card-title">UI / UX Designer</div>
                       <div class="job-card-subtitle"> 2711 Ash Dr. San Jose, South Dark. </div>
                     </div>
                     <svg class="heart"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
                       <path d="M20.8 4.6a5.5 5.5 0 00-7.7 0l-1.1 1-1-1a5.5 5.5 0 00-7.8 7.8l1 1 7.8 7.8 7.8-7.7 1-1.1a5.5 5.5 0 000-7.8z" />
                     </svg>
               ...
               <div class="job-overview-card">
                 <div class="job-card overview-card">
                   <div class="overview-wrapper">
                     <svg viewBox="0 0 24 24"  style="background-color: #fe5b5f">
                     ...
                     <div class="overview-detail">
                       ...
                       <div class="job-card-subtitle"> 1725 Preston Rd. Inglewood. </div>
                     </div>
                     <svg class="heart"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
                       <path d="M20.8 4.6a5.5 5.5 0 00-7.7 0l-1.1 1-1-1a5.5 5.5 0 00-7.8 7.8l1 1 7.8 7.8 7.8-7.7 1-1.1a5.5 5.5 0 000-7.8z" />
                     </svg>
               ...
               <div class="job-overview-card">
                 <div class="job-card overview-card">
                   <div class="overview-wrapper">
                     <svg viewBox="0 0 24 24"  style="background-color: #5c6bc0">
                       <g fill="#fff">
               ...
               <div class="job-overview-card">
                 <div class="job-card overview-card">
                   <div class="overview-wrapper">
                     <svg viewBox="0 0 24 24"  fill="#fff" style="background-color:#ea4c88">
                     ...
                     <div class="overview-detail">
                       <div class="job-card-title">UI / UX Designer</div>
                       <div class="job-card-subtitle"> 1976 Thornide Joshua. Andr Maria. </div>
                     </div>
                     <svg class="heart"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
                       <path d="M20.8 4.6a5.5 5.5 0 00-7.7 0l-1.1 1-1-1a5.5 5.5 0 00-7.8 7.8l1 1 7.8 7.8 7.8-7.7 1-1.1a5.5 5.5 0 000-7.8z" />
                     </svg>
         ...
         <div class="job-title-wrapper">
           <div class="job-card-title">UI /UX Designer shubham-1</div>
           <div class="job-action">
             <svg class="heart"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart">
               <path d="M20.8 4.6a5.5 5.5 0 00-7.7 0l-1.1 1-1-1a5.5 5.5 0 00-7.8 7.8l1 1 7.8 7.8 7.8-7.7 1-1.1a5.5 5.5 0 000-7.8z" />
             </svg>
             <svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-share-2">
         ...
         <div class="jobs-apply-buttons d-flex align-items-center mt-5 mb-2">
             <a href="#" class="btn-blue d-inline-blue border-0 w-50 text-center">Apply Now</a>&nbsp;&nbsp;<a href="#" class="btn-default w-50 text-center">Refer a friend</a>
         </div>
         <div class="jobs-share-btn-div mt-4 social-partners">
             <div class="container-fluid">
             <div class="row d-flex align-items-center text-center">
             <div class="col s-icon-div">
                 <div class="s-icons">
   ...
   <!----------------------------jobs main section--------------------------->
        ...
        <section id="apply_job_form_modal">
                        ...
                        <form>
                            <div class="row align-items-center">
                                <div class="col-md-8 col-sm-8">
                                    <div class="drop-zone">
                                        <span class="drop-zone__prompt" class="m-auto">Drop file or click to upload</span>
                                            <input type="file" name="myFile" class="drop-zone__input" />
                                        </div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <a href="javascript:void(0)" class="btn-yellow d-block text-center mb-3 shadow-none">Sign in with LinkedIn</a>
                                    <a href="javascript:void(0)" class="btn-blue d-block text-center m-0 shadow-none"> Apply with Indeed</a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="Lname" placeholder="Enter your first name">
                                ...
                                <div class="col-md-12">
                                    <div class="fs-5 mb-1">Message to Hiring Manager</div>
                                    <div class="form-group">
                                    <label class="fs-14 fw-normal" for="exampleFormControlTextarea1">Let the company know about your interest working there</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="fs-5">Experience</div>
                                        <a href="javascript:void" class="btn-blue  d-inline-block" id="add_more_feild">
                                            <i class="bi bi-plus-lg line-height-10px me-s"></i>
                                            <span>Add</span>
                                            </a>
                                    </div>
                                </div>
                                <div id="append_Experience_form_here"> </div>
                            </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="fs-5">Education</div>
                                        <a href="javascript:void" class="btn-blue  d-inline-block" id="add_more_feild_education">
                                            <i class="bi bi-plus-lg line-height-10px me-s"></i>
                                            <span>Add</span>
                                            </a>
                                    </div>
                                </div>
                                <div id="append_Education_form_here"> </div>
                            </div>

                            <div class="row">
                                <div class="col-md-12">
                                    <p class="fs-14"> <input type="checkbox" class="me-1 "> By checking this box, you will declare that you read and understand the privacy policy of B.</p>
                                </div>
                            </div>
                        </form>
     ...
     <div class="hide clone-form">
          <div class="bg-light-blue p-3 mt-3 mb-3" id="clone-form_experience">
         <div class="row">
             <div class="col-md-6">
                 <div class="form-floating mb-3">
             ...
             <div class="col-md-6">
                 <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="Company" placeholder="Company">
                                        <label for="Company">Company</label>
                                    </div>
             </div>
              <div class="col-md-12">
                 <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="Office_location" placeholder="Office location">
                                        <label for="Office_location">Office location</label>
                                    </div>
             </div>
             <div class="col-md-12">
              <div class="form-group">
                    <label class="fs-14 fw-bold" for="Description">Description</label>
                    <textarea class="form-control" id="Description" rows="3"></textarea>
                </div>
             </div>
         </div>
     </div>
          <div class="bg-light-blue p-3 mt-3 mb-3" id="clone-form_education">
         <div class="row">
             <div class="col-md-12">
                 <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="Title" placeholder="Title">
                                        <label for="Title">Institution <i class="bi bi-asterisk"></i> </label>
                                    </div>
             </div>
             <div class="col-md-6">
                 <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="Company" placeholder="Company">
                                        <label for="Company">Major</label>
                                    </div>
             </div>
              <div class="col-md-6">
                 <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="Office_location" placeholder="Office location">
                                        <label for="Office_location">Degree</label>
                                    </div>
             </div>
              <div class="col-md-12">
                 <div class="form-floating mb-3">
                                        <input type="number" class="form-control" id="Office_location" placeholder="Office location">
                                        <label for="Office_location">School location</label>
                                    </div>
             </div>
            <div class="col-md-6">
                <div class="form-floating mb-3">
                    <input type="date" class="form-control" id="C_from">
                    <label for="Office_location">From</label>
                </div>
           </div>
             <div class="col-md-6">
                <div class="form-floating mb-3">
                    <input type="date" class="form-control" id="C_to">
                    <label for="Office_location">To</label>
                </div>
           </div>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    ...
    $('#add_more_feild').on('click', function(){
        $('#append_Experience_form_here').append($('#clone-form_experience').clone());
    });

    $('#add_more_feild_education').on('click', function(){
        $('#append_Education_form_here').append($('#clone-form_education').clone());
    });
...
$("#back_to_jobs").click(function(){
    $('.wrapper').removeClass('detail-page')
})
