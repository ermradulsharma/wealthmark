...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <body class="bg-white seller_from_buy_tab">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                      ...
                      <div id="my-div1">
                            <div class="bg-light-theme rounded order-noti-txt">
                                <h5>Transfer Assets to Buyer afer receiving asset amount</h5>
                                <div class="rounded show fs-14 fw-bold" role="alert">
                            ...
                            @if(!empty($buyer_details) && $get_order_data->order_status==1)
                               <div class="ordered-user-info">
                                   <div class="bg-white p-3">
                                    <h5 class="fs-14">  
                                        <span><?php echo $buyer_details->first_name; ?></span>
                                        <span class="fs-12">
                   ...
                   <div class="wm-chatbox bg-light-blue p-3">
                      <div class="chat-box">
                         <div class="header" id="my-div2">
                            ...
                            <span class="name">
                            @if(!empty($buyer_details) && $get_order_data->order_status==1)
                                <?php echo $buyer_details->first_name; ?>
                                  ...
                                  @if(Auth::user()->government_id_verified == 1)
                                    ...
                                    <div class="fs-12">
                                        @if(Cache::has('user-is-online-' . $buyer_details->id))
                          ...
                          @if(!empty($buyer_details))
                           <div class="chat-room scrollbar-style">
                            ...
                            <input type="text" name="chat_message_{{$buyer_details->id}}" id="chat_message_{{$buyer_details->id}}" class="form-control chat_message border-0" placeholder="Type messages here..."/>
...
<script>
    ...
    function chek_notification(){
        var orderid = '<?php echo isset($_SESSION['orderid']); ?>';
    $.ajax({
    ...
    $(document).ready(function(){
        ...
        function startTimer(orderId, payment_time_limit) {
            $.ajax({
                type: 'POST',
                url: '{{ route('test') }}',
                data:{
...
var element = document.querySelector('.chat-room');
  ...
  <!--   <section class="inner-page authentication-step pb-0">-->
      ...
      <!--                       <button type="button"  id="" onclick="deleteRating('')" class="deleterating exp-2 border border-1 p-2 deleterating"><i class="bi bi-trash"></i></button>-->
      <!--                  </div>-->
      <!--                  @endif-->
      <!--             </div>-->
...
<!--                                </td>-->
<!--                                 <td>-->
<!--                                      <a class="btn-yellow border-0 w-100" onClick="openAppeal_stepOne()">Appeal</a>-->
<!--                                 </td>-->
<!--                            </tr>-->
<!--                        </table>-->
<!--                </div> -->
...
<!--     <div class="wm-custom-modal-body px-3 ">-->
<!--                  <div class="container-fluid p-0 m-0">-->
<!--                     <div class="scrollbar-style max-height-600px mb-3 pe-2">-->
...
<!--                              </li>-->
<!--                           </ol>-->
<!--                           <div class="apeal-basic-info bg-light-blue p-2">-->
<!--                              <div class="fs-12 fw-normal d-flex alin-items-center"> <i class="bi bi-arrow-right-short me-2 yellow-text"></i><span> Submitted contents are visible to both parties and CS. Avoid including any private or sensitive info. </span></div>-->
<!--                              <div class="fs-12 fw-normal d-flex alin-items-center"> <i class="bi bi-arrow-right-short me-2 yellow-text"></i><span> Baseless appeals can result in account ban.</span></div>-->
<!--                              <div class="fs-12 fw-normal d-flex alin-items-center"> <i class="bi bi-arrow-right-short me-2 yellow-text"></i><span> CS review takes a few hours. More proof parties might be requested.</span></div>-->
<!--                           </div>-->
...
<!--                                             </div>-->
<!--                                 <div class="lf-select-coin-to-active-value lf-select-coin-to-active-div height-48px">-->
<!--                                    <div class="wm-dropdown-optn-item-div">-->
<!--                                       <div id="select_coin_text" class="wm-dropdown-optn-item-txt">Select reaseon for appeal</div>-->
<!--                                    </div>-->
<!--                                 </div>-->
...
<!--                                             <div class="wm-dropdown-optn-item-div">-->
<!--                                                <div class="wm-dropdown-optn-item-txt">I have made a payment but the seller has not released the crypto.</div>-->
<!--                                             </div>-->
<!--                                          </div>-->
<!--                                       </li>-->
...
<!--                                             <div class="wm-dropdown-optn-item-div">-->
<!--                                                <div class="wm-dropdown-optn-item-txt">I paid exra money to the seller.</div>-->
<!--                                             </div>-->
<!--                                          </div>-->
<!--                                       </li>-->
...
<!--                                          <div class="wm-dropdown-optn-item-inner">-->
<!--                                             <div class="wm-dropdown-optn-item-div">-->
<!--                                                <div class="wm-dropdown-optn-item-txt">I did not receive payment from the buyer</div>-->
<!--                                             </div>-->
<!--                                          </div>-->
<!--                                       </li>-->
<!--                                       <li role="option" id="17" title="17" class="wm-dropdown-optn-item ">-->
<!--                                          <div class="wm-dropdown-optn-item-inner">-->
<!--                                             <div class="wm-dropdown-optn-item-div">-->
<!--                                                <div class="wm-dropdown-optn-item-txt">I received payment from the buyer but the amount is incorrect.</div>-->
<!--                                             </div>-->
<!--                                          </div>-->
<!--                                       </li>-->
...
<!--                                          <div class="wm-dropdown-optn-item-inner">-->
<!--                                             <div class="wm-dropdown-optn-item-div">-->
<!--                                                <div class="wm-dropdown-optn-item-txt">I received payment but the payment info does not match the buyer's name.</div>-->
<!--                                             </div>-->
<!--                                          </div>-->
<!--                                       </li>-->
...
<!--                                       <li role="option" id="33" title="33" class="wm-dropdown-optn-item ">-->
<!--                                          <div class="wm-dropdown-optn-item-inner">-->
<!--                                             <div class="wm-dropdown-optn-item-div">-->
<!--                                                <div class="wm-dropdown-optn-item-txt">Funds received, although I am unable to release order due to an inernal system error or OTP issue.</div>-->
<!--                                             </div>-->
<!--                                          </div>-->
<!--                                       </li>-->
...
<!--                              </div>-->
<!--                              <div class="p-2"></div>-->
<!--                              <h6 class="title fs-14 mt-3">Description</h6>-->
<!--                              <div class="position-relative">-->
<!--                                 <textarea class="form-control" id="appeal_description" name="text" placeholder="Please describe the complaint as detailed as possible" rows="5"></textarea>-->
<!--                                 <span class="fs-12 appeal_count_message">   <span id="count_message"></span> 0/500 </span>-->
<!--                              </div>-->
<!--                              <div class="p-2"></div>-->
<!--                             <h6 class="title fs-16">Upload Proof (Mandatory)</h6>-->
<!--                           <div class="mb-3 fs-14 text-black">-->
<!--                             Screenshots or video/audio recordings of payment and communication data should not exceed a total of 5 files with total size of 200 MB. Supported file formats include pdf. jpg, jpeg, png mp3, mp4, avi,rm, rmvb, mov, wmv.-->
<!--                           </div>-->
<!--                           <ul class="ul-list">-->
<!--                               <li class=""><i class="bi bi-check"></i> <small> Ensure that the date, time, account, number and name of the sender and recipient are displayed in the payment transaction details. </small></li>-->
<!--                               <li class=""><i class="bi bi-check"></i> <small>Video should show the entire payment account login in process (please hide the password), and the payment transaction details. </small></li>-->
<!--                               <li class=""><i class="bi bi-check"></i> <small>Video must be recorded using another phone/camera and unedited. </small></li>-->
<!--                               <li class=""><i class="bi bi-x text-danger"></i> <small> Account will be restricted if fake payment proof is provided. </small></li>-->
<!--                           </ul>-->
                           
<!--                           <div class="bg-light-blue p-2">-->
<!--                               <h6>  Upload file (Payemnt Proof)  </h6>-->
<!--                               <div class="upload__box">-->
<!--                                <div class="upload__btn-box">-->
<!--                                    <label class="upload__btn">-->
<!--                                        <p><i class="bi bi-plus"></i> </p>-->
