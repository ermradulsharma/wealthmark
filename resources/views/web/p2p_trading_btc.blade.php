...
<head>
    ...
    <link rel='stylesheet' href="{{ asset('pak_custom.css') }}">
        ...
        <div class="container">
            <div class="row">
                <div class="overview-inner-box text-center">
                    <h3 class="digital-asset-heading text-white">Buy and Sell BTC with Your Preferred Payment Methods
                    </h3>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div class="tab-content" id="trading-myTabContent">
                        <div class="tab-pane {{ (Request::segment(3) == 'btc') ? 'show active':'fade'}}" id="p2p-trading-BTC" role="tabpanel"
                            aria-labelledby="p2p-trading-BTC-tab">
                            <div id="table_data2">   
                            @include('web.p2p_trading_ajax_btc')  
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div id="table_data_buy">
                     ...
                     <h3>BUY COINS</h3>
                      @include('web.p2p_trading_ajax_btc_buy')
                    </div>
                </div>
            </div>
                       ...
                       <div class="lf-select_coin-to rounded mb-5">
                         ...
                         <div class="lf-select-coin-to-active-value lf-select-coin-to-active-div">
                           <div class="wm-dropdown-optn-item-div">
                             <img id="select_coin_img" class="wm-dropdown-optn-item-img" src="https://www.wealthmark.io/96d50-2408-43e1-ad4c-78b47b448a6a.png">
                           ...
                           <ul role="listbox" class="wm-dropdown-list wm-dropdown-list-css">
                             <li role="option" id="16" title="16" class="wm-dropdown-optn-item " onclick="changeSrc2(this.id)">
                               <div class="wm-dropdown-optn-item-inner">
                                 <div class="wm-dropdown-optn-item-div">
                                   <img class="wm-dropdown-optn-item-img" src="https://www.wealthmark.io/96d50-2408-43e1-ad4c-78b47b448a6a.png">
           ...
           // console.log(this.id);
            ...
            if(clickedid == 'p2p-trading-ETH-tab'){
             ...
             var appLocale = "<?php echo url(app()->getLocale()) ?>";
                    $.ajax({    
                    type: "GET",
                    url: appLocale +"/en/p2p-trading/eth", 
                    data:{page:pageURL},            
                    dataType: "html",                  
                    success: function(data){ 
                        //document.location.reload();
...
<script>
    $(document).ready(function(){
        ...
        function fetch_data(page){
             var appLocale = "<?php echo url(app()->getLocale()) ?>";
            $.ajax({
                url:appLocale +"/p2p-trading/btc?page="+page,
                success:function(data){
        ...
        function refresh(id) {
            ...
            if (id === 'five-sec') {
                ...
                intervalId = setInterval(function() {
                    ...
                    $('#table_data2').load(location.href + '#table_data2');
                }, 5000);
            } else if (id === 'ten-sec') {
    ...
    function sell_btc(id){
      ...
      //  alert(ifAuth);
        ...
        if(ifAuth == 'true'){
            ...
            var btc = id;
            //console.log(btc);
            var buyer_name = $('#'+btc+' ' +' .buyer_name').text();
            var buyer_order_completion = $('#'+btc+' ' +' .buyer_order_completion').text();
            var buyer_cr_value = $('#'+btc+' ' +' .buyer_cr_value').text();
            var buyer_cr_type = $('#'+btc+' ' +' .buyer_cr_type').text();
            var buyer_payment_type = $('#'+btc+' ' +' .buyer_payment_type').text();
            var buyer_Crypto_type = $('#'+btc+' ' +' .buyer_Crypto_type').text();
