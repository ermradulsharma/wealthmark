...
a.btn.btn-blue.shadow:hover {
    background: linear-gradient(180deg, rgba(254, 192, 15, 1) 0%, rgba(248, 165, 50, 1) 100%)!important;
}
  </style>
                ...
                <div class="row">
                 ...
                 <div class="col-6">
                       <div class="text-right">
                                                                           <a class="btn btn-yellow shadow" href="{{ route('plans.index') }}"> Back</a>
                                                                    </div>
                </div>
           </div>
                            </div>
        ...
        <form action="{{ route('plans.store') }}" method="POST">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 my-3 d-flex justify-content-end align-items-center">
                                        <button type="submit" class="btn btn-blue shadow">Submit</button>
                                    </div>
                                </div>
