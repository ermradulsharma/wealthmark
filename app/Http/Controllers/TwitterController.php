...
class TwitterController extends Controller
{
    ...
    public function trade(Request $request){  // craeted to remove hidden values 18052023 at 12.55pm
            // dd($request->all());
         ...
         $currencyData = currencies::where('name', $request->selectedcurrency)->first();
         $cryptoData = currencies::where('name', $request->selectedcrypto)->first();
          ...
          //  return $bmk_price;
                  ...
                  if(isset($request->amountCurrency) && !empty($request->amountCurrency)){
                      ...
                      // print_r('amountCurrency is set');
                        ...
                        $selectedCurrency = currencies::where('name', $request->selectedcurrency)->first();
