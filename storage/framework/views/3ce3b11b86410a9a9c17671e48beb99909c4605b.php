  ...
  <footer id="footer">
   ...
   <div class="wrapper">
      <div class="hero">
         <div class="">
            <img loading="lazy" class="sc-fmlJrY buZCMp logo" src="<?php echo e(asset('assets/img/wealthmark-logo.svg')); ?>" alt="Wealthmark Logo">
         </div>
         <div class="download-apps">
            <div class="set">
               <a href="" target="_blank" rel="noopener noreferrer">
               <img loading="lazy" class="item" src="<?php echo e(asset('assets/img/google_play.svg')); ?>" alt="Google Play Icon"></a>
               <a href="" target="_blank" rel="noopener noreferrer">
               <img loading="lazy" class="item" src="<?php echo e(asset('assets/img/app-store.svg')); ?>" alt="App Store Icon"></a>
               <a href="" target="_blank" rel="noopener noreferrer">
               <img loading="lazy" class="item" src="<?php echo e(asset('assets/img/window-10.svg')); ?>" alt="Windows Icon"></a>
               <a href="" target="_blank" rel="noopener noreferrer">
               <img loading="lazy" class="item" src="<?php echo e(asset('assets/img/macos.svg')); ?>" alt="Mac App Icon"></a>
            </div>
         </div>
      </div>
      <div class="menu">
         <div class="menu-item">
            ...
            <div class="submenu">
				<ul>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'about-us')); ?>">About</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'careers')); ?>">Careers</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'about-us')); ?>">Business Contacts</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'community')); ?>">Community</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'wealthmark-blog')); ?>">WealthMark Blog</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'terms')); ?>">Terms</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'privacy')); ?>">Privacy</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'announcements')); ?>">Announcements</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'news')); ?>">News</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'notices')); ?>">Notices</a></li>
                </ul>
            </div>
         </div>
         <div class="menu-item">
            ...
            <div class="submenu">
				<ul>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'downloads')); ?>">Downloads</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'desktop-application')); ?>">Desktop Application</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'vip-institutional-services')); ?>">Institutional &amp; VIP Services</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'referral-offers')); ?>">Referral</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'execution-solutions')); ?>">Execution Solutions</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'affiliate')); ?>">Affiliate</a></li>
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'bmkoin')); ?>">BMKoin</a></li>-->
                  <li><a href="<?php echo e(url( app()->getLocale(), 'otc-trading')); ?>">OTC Trading</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'listing-application')); ?>">Listing Application</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'p2p-merchant-application')); ?>">P2P Merchant Application</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'historical-market-data')); ?>">Historical Market Data</a></li>
                </ul>
            </div>
         </div>
         <div class="menu-item">
            ...
            <div class="submenu">
                <ul>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'give-us-feedback')); ?>">Give Us Feedback</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'support-center')); ?>">Support Center</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'submit-request')); ?>">Submit a request</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'api-documentation')); ?>">API Documentation</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'fees')); ?>">Fees</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'trading-rules')); ?>">Trading Rules</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'wealthmark-verify')); ?>">WealthMark Verify</a></li>
                  <li><a href="<?php echo e(url( app()->getLocale(), 'law-enforcement-requests')); ?>">Law Enforcement Requests</a></li>
                </ul>
            </div>
         </div>
         <div class="menu-item">
         ...
         <div class="menu-item">
            ...
            <div class="submenu">
                <ul>
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-bmkoin')); ?>">Buy BMKoin</a></li>-->
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-busd')); ?>">Buy BUSD</a></li>-->
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-bitcoin')); ?>">Buy Bitcoin -BTC</a></li>-->
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-ethereum')); ?>">Buy Ethereum - ETH</a></li>-->
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-litecoin')); ?>">Buy Litecoin</a></li>-->
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-ripple')); ?>">Buy Ripple</a></li>-->
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-bitcoin-cash')); ?>">Buy Bitcoin Cash</a></li>-->
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-dogecoin')); ?>">Buy Dogecoin</a></li>-->
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-defi')); ?>">Buy DeFi</a></li>-->
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-shib')); ?>">Buy SHIB</a></li>-->
                  <!--<li><a href="<?php echo e(url( app()->getLocale(), 'buy-tradable-altcoins')); ?>">Buy Tradable Altcoins</a></li>-->


                <li><a href="<?php echo e(url( app()->getLocale(), 'buy-bmkoin')); ?>">Buy Bmkoin - BMK</a></li>
                <li><a href="<?php echo e(url( app()->getLocale(), 'buy-bitcoin')); ?>">Buy Bitcoin - BTC</a></li>
                <li><a href="<?php echo e(url( app()->getLocale(), 'buy-ethereum')); ?>">Buy Ethereum - ETH</a></li>
                <li><a href="#">Buy Tether - USDT</a></li>
                <li><a href="#">Buy Solana (SOL)</a></li>
                <li><a href="#">Buy Cardano (ADA)</a></li>
                <li><a href="<?php echo e(url( app()->getLocale(), 'buy-dogecoin')); ?>">Buy Dogecoin - DOGE</a></li>
                <li><a href="#">Buy XRP (XRP)</a></li>
                <li><a href="#">Buy Polkadot - DOT</a></li>
                <li><a href="<?php echo e(url( app()->getLocale(), 'buy-litecoin')); ?>">Buy Litecoin - LTC</a></li>
...
<script>
	...
	{
		$.ajax({
			url:"<?php echo e(url('')); ?>/update-user-last-activity",
			success:function()
			{
    ...
    // console.log(sessionid+'-'+auth_chk);
  	function check_session_id(){
    		...
    		fetch('<?php echo e(url( app()->getLocale())); ?>/check_login').then(function(response){
    			return response.json();
    		}).then(function(responseData){
    			if(responseData.output == 'logout')
    			{
    				window.location.href = '<?php echo e(url( app()->getLocale())); ?>/user/logout';
    			}
    		}).catch(function(err) {
                  //console.log(err);
              });
...
if(
    ...
    (  window.location.href != "<?php echo e(url(app()->getLocale().'/user/confirmed-order-info')); ?>"  ||    window.location.href != "<?php echo e(url(app()->getLocale().'/user/seller-confirm-order')); ?>"
    )
    ){
...
<?php endif; ?>
  ...
  function orderNotifyPopup(trader_id) {
        ...
        $.ajax({
             type: 'GET',
             url: '<?php echo e("/getOrderStatusByUserID"); ?>',
           data: {
                         ...
                         if(data.count > 0){
                            ...
                            if(data.getRecentOrders.ordertype == 1 && data.getRecentOrders.seller_id == trader_id){
                                  ...
                                  $('#orderNotifyPopup .traderDetails .traderDetails_dateTime').text(formattedDateTime);
                                   ...
                                   $('#orderNotifyPopup #view_order').attr('href', '<?php echo e(url(app()->getLocale())."/p2p-trading/buy/seller-confirm-order-info"); ?>'+'/'+data.getRecentOrders.id);
                               }
                            ...
                            if(data.getRecentOrders.ordertype == 0 && data.getRecentOrders.buyer_id == trader_id){
                                 ...
                                 $('#orderNotifyPopup #view_order').attr('href', '<?php echo e(url(app()->getLocale())."/user/confirmed-order-info"); ?>'+'/'+data.getRecentOrders.id);
...
<?php if(Auth::check() == 1 || Auth::check() === true){ ?>
    ...
    //alert(onlineStatus);
        ...
        $.ajax({
             type: 'GET',
             url: '<?php echo e(url("/getexpressOrderStatus")); ?>',
                data: {
                    '_token': "<?php echo e(csrf_token()); ?>",
                    'user_id' : user_id,
                    'trader_id' : trader_id
                  ...
                  if(data.getRecentOrders != null){
                         ...
                         if(data.count > 0){
                                        ...
                                        var availablepaymentmethodid =   $.ajax({
                                              url:  '<?php echo e(url("/getpaymentmethodByuserid")); ?>',
    ...
    function checkorderstatus (){
        var orderid = $('#expressOrderNotifyPopup #view_order').attr('orderSerialID');
         ...
         $.ajax({
             type: 'POST',
             url: '<?php echo e(url("/checkOrderAcceptedorNot")); ?>',
                data: {
                    '_token': "<?php echo e(csrf_token()); ?>",
...
/* check pending order for auth user if pending order found then popup not shows else popup show*/
    <?php if(auth()->guard()->check()): ?>
     function checkpendingordersornot (){
        $.ajax({
            type: 'POST',
            url: '<?php echo e(url("/checkpendingorders")); ?>',
            data: {
                '_token': "<?php echo e(csrf_token()); ?>",
...
<script>
  ...
  <!-- End Footer -->
<?php /**PATH D:\wealthMark\resources\views/template/footer.blade.php ENDPATH**/ ?>