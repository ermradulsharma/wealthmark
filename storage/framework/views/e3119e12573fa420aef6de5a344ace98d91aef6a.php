                ...
                success: function(data) {
                    if (data.notificationCount > 0) {
                        ...
                        $.each(data.nofification, function(key, val) {
                            ...
                            html +=
                                '<img src="<?php echo e(asset('assets/img/msg-box.png')); ?>" class="header-icons" alt="Responsible Trading" />';
...
<?php /**PATH D:\wealthMark\resources\views/template/web_footer.blade.php ENDPATH**/ ?>