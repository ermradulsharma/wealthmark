...
<script src="<?php echo e(asset('assets/js/cookie_consent.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/main.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/dark-mode-switch.js')); ?>"></script>
...
<script>
    ...
    $(document).ready(function() {
        $('#set_country').click(function() {
            ...
            $.ajax({
                type: "GET",
                url: '<?php echo e(url(app()->getLocale() . '/set_country')); ?>',
                data: {
...
<script>
    function webnotificationactivity(id) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo e(route('getNotificationActivity')); ?>',
            data: {
...
<?php if(auth()->guard()->check()): ?>
    <script>
        ...
        function getLatestNotifications() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route('getLatestNotifiation')); ?>',
                data: {
                    '_token': "<?php echo e(csrf_token()); ?>",
                    'userId': userId,
                },
                success: function(data) {
                    if (data.notificationCount > 0) {
                        ...
                        $.each(data.nofification, function(key, val) {
                            ...
                            html +=
                                '<img src="<?php echo e(asset('img/msg-box.png')); ?>" class="header-icons" alt="Responsible Trading" />';
        ...
        function getNotificationCount() {
            ...
            $.get('<?php echo e(route('count-notification')); ?>', function(response) {
        ...
        offtimer = setInterval(function() {
            ...
            if (count > 0) {
                ...
                if (getcount === 0) {
                    ...
                    $.get('<?php echo e(route('cancel-order', ['id' => ':id'])); ?>'.replace(':id', orderId),
                        function(response) {
                            if (response.success) {
...
<script>
    $('#expressOrderNotifyPopup #view_order').click(function() {
        ...
        if ($.isNumeric(orderId)) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(url('/expressOrderConfirmation')); ?>',
                data: {
                    '_token': "<?php echo e(csrf_token()); ?>",
                ...
                success: function(data) {
                    ...
                    console.log(data);
                    location.href =
                        '<?php echo e(url(app()->getLocale() . '/user/express-confirmed-order-seller-info')); ?>';
...
<?php /**PATH D:\Laravel Project\wealthMark\resources\views/template/web_footer.blade.php ENDPATH**/ ?>