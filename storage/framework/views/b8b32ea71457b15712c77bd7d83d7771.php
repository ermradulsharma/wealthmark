  ...
  <footer id="footer">
   ...
   <div class="wrapper">
      <div class="hero">
         <div class="">
            <img loading="lazy" class="sc-fmlJrY buZCMp logo" src="<?php echo e(asset('img/wealthmark-logo.svg')); ?>" alt="Wealthmark Logo">
         </div>
         <div class="download-apps">
            <div class="set">
               <a href="" target="_blank" rel="noopener noreferrer">
               <img loading="lazy" class="item" src="<?php echo e(asset('img/google_play.svg')); ?>" alt="Google Play Icon"></a>
               <a href="" target="_blank" rel="noopener noreferrer">
               <img loading="lazy" class="item" src="<?php echo e(asset('img/app-store.svg')); ?>" alt="App Store Icon"></a>
               <a href="" target="_blank" rel="noopener noreferrer">
               <img loading="lazy" class="item" src="<?php echo e(asset('img/window-10.svg')); ?>" alt="Windows Icon"></a>
               <a href="" target="_blank" rel="noopener noreferrer">
               <img loading="lazy" class="item" src="<?php echo e(asset('img/macos.svg')); ?>" alt="Mac App Icon"></a>
            </div>
         </div>
      </div>
      <div class="menu">
...
<script>
  ...
  <!-- End Footer -->
<?php /**PATH D:\Laravel Project\wealthMark\resources\views/template/footer.blade.php ENDPATH**/ ?>