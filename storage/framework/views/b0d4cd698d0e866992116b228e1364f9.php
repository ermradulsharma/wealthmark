...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
   <head>
     ...
     <link href="<?php echo e(asset('assets/disk/slidercaptcha.min.css')); ?>" rel="stylesheet" />
    <!--<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css">-->
      ...
      <link rel="stylesheet" href="<?php echo e(asset('assets/css/QapTcha.jquery.css')); ?>" type="text/css" />

       <link rel="stylesheet" href="<?php echo e(asset('assets/css/intlTelInput.css')); ?>" />
       <link rel="stylesheet" href="<?php echo e(asset('assets/css/login_register.css')); ?>" />
...
/*}*/
   ...
   <body class="bg-white">
      <?php echo $__env->make('template.custom_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <main id="main">
         <section class="inner-page register p-0">
            <div class="container">


                   <!--<?php if( Request::segment(3) == 'loginFailed' ): ?>-->
                   <!--     <div class="row">-->
               ...
               <div class="row">
                   <div class="col-lg-4 col-md-6 offset-lg-1 order-md-2">
                     <div class="login_scan">WealthMark Account Login
                        <div class="qr_code">
                           <img src="<?php echo e(asset('assets/img/qr-code.png')); ?>" class="img-responsive" />
                        </div>
                     ...
                     <div class="">
                        ...
                        <div class="other-login-option">
                            <div class="google-login">
                               <div class="google">
                                  <div class="google-div">
                                     <img src="<?php echo e(asset('assets/img/google-icon.png')); ?>" class="other-login-img">

                                  </div>

                                  <div class="text m-0 p-0 googleAuth"> <a href="<?php echo e(url('auth/google')); ?>" >
                            ...
                            <div class="apple-login">
                               <div class="apple">
                                  <div class="apple-div">
                                     <img src="<?php echo e(asset('assets/img/apple-icon.png')); ?>" class="other-login-img">
                                  </div>
                        ...
                        <div class="pt-3 pb-3">
                            ...
                            <p> <span class="text-muted">Don't have an account?<a href="<?php echo e(url( app()->getLocale())); ?>/register" class="text-theme-yellow"> Register Now</a></span></p>
                        </div>
                    </div>
                  </div>
                    ...
                    <div class="modal-dialog" style="max-width:400px;margin:10% auto;">
                        <div class="modal-content pt-3 pb-3 p-3">
                            <div class="modal-header mb-3 mt-3 p-0 text-center border-0">
                                <img class="warning-img  mx-auto" src="<?php echo e(url('assets/img/warning.svg')); ?>" >
                            </div>
                            ...
                            <div class="modal-footer justify-content-around mt-3 border-0 p-0">
                                 ...
                                 <a href="<?php echo e(url(app()->getLocale()."/reset-password")); ?>" class="btn btn-yellow got-it">Continue</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('template.copy_right_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


       <?php echo $__env->make('template.web_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

      <!--<script type="text/javascript" src="https://code.jquery.com/jquery-3.5.1.js"></script> -->
     <script type="text/javascript" src="<?php echo e(asset('assets/js/intlTelInput-jquery.min.js')); ?>"></script>
      <script src="<?php echo e(asset('assets/js/alert.js')); ?>"></script>
      <script src="https://code.jquery.com/ui/1.13.2/jquery-ui.js"></script>
      <script type="text/javascript" src="<?php echo e(asset('assets/js/jquery.ui.touch.js')); ?>"></script>
      <script type="text/javascript" src="<?php echo e(asset('assets/js/QapTcha.jquery.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/disk/longbow.slidercaptcha.min.js')); ?>"></script>
    <script>
    ...
    //             $.post( '<?php echo url( 'api/verify_captcha');  ?>',{
             ...
             setSrc:function () {
                          ...
                          return '<?php echo e(asset('assets/img/captchaImages/')); ?>' +'/'+Math.round(Math.random() * 20) +'.jpg';
                         // return '<?php echo e(asset('assets/img/captchaImages/1.jpg')); ?>';
...
<?php /**PATH D:\Laravel Project\wealthMark\resources\views/auth/login.blade.php ENDPATH**/ ?>