        ...
        <div class="container-fluid mt-3">
            <div class="row justify-content-evenly align-items-center">
                ...
                <div class="col-lg-4 order-1 order-lg-2 hero-img text-center py-3" data-aos="zoom-in"
                    data-aos-delay="200">
                    <img src="<?php echo e(asset('assets/img/home-page/home-graphic-1-01.png')); ?>"
        ...
        <div class="container-fluid">
            <div class="row features-items">
                <div class="col-md-4 col-sm-6 equal-height">
                    <div class="item">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/img/home-page/create-an-account.svg')); ?>"
                ...
                <div class="col-md-4 col-sm-6 equal-height">
                    <div class="item">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/img/home-page/add-funds.svg')); ?>" alt="Add funds to wallet"
                ...
                <div class="col-md-4 col-sm-6 equal-height">
                    <div class="item">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/img/home-page/investing-in-crypto.svg')); ?>"
                ...
                <div class="col-md-4 col-sm-6 equal-height border-bottom-none">
                    <div class="item">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/img/home-page/insured-by-bitgo.svg')); ?>" alt="Safe & Secure"
                                title="Safe & Secure">
                        </div>
                        <div class="info">
                            <h4>Safe & Secure</h4>
                ...
                <div class="col-md-4 col-sm-6 equal-height border-bottom-none">
                    <div class="item">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/img/home-page/deep-encryption.svg')); ?>" title="Deep encryption"
                                alt="Deep encryption">
                        </div>
                        <div class="info">
                ...
                <div class="col-md-4 col-sm-6 equal-height border-bottom-none">
                    <div class="item">
                        <div class="icon">
                            <img src="<?php echo e(asset('assets/img/home-page/safe-security.svg')); ?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content pt-3 pb-3 p-3">
                <div class="modal-header">
                    <img class="warning-img" src="<?php echo e(asset('assets/img/warning.svg')); ?>" alt="warning"
                        alt="warning">
                </div>
...
<?php /**PATH D:\wealthMark\resources\views/web/index.blade.php ENDPATH**/ ?>